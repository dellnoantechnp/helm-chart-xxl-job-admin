...
-- Install steps:
--
-- 1. You must create database for PrometheusAlert first like this:
--
--  >_ CREATE DATABASE 'prometheusalert' CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
--
-- 2. The table scheme is automatic create on application start complete.
--
-- 3. Manually execute this SQL content.
--
-- 4. The end to be restart prometheusAlert container/pod.
--
-- Document pages: https://github.com/feiyu563/PrometheusAlert/blob/master/doc/readme/base-install.md
